...
class FiniteTrace:
    ...
    """
    def __init__(self, trace_list: List[List[AtomicProposition]], system: ParametricTransitionSystem):
        # Input Processing
...
class InfiniteTrace:
    ...
    """
    def __init__(self, prefix: List[List[AtomicProposition]], suffix: List[List[AtomicProposition]], system: ParametricTransitionSystem):
        # Input Processing
        assert len(suffix) > 0
